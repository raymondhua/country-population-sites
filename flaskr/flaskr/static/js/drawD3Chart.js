function drawGraph(worldOBJ, selectedOBJ) {
    ...
    //Adds new data from the API into the array using the function below
    ...
    g.append("g")
        ...
        .on("mouseout", tip.hide) //When the user hover overs the bar line it displays a tip containing the information
        .on("mouseover", tip.show); //When the user hover hovers out of the graph line it hides a tip
...
//Function that passes in the data and returns the object
